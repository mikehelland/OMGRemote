    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_DOWN: {
                ...
                //touch.playingHandle =
                mChannel.playLiveNote(playNote, true);
            ...
            case MotionEvent.ACTION_POINTER_UP: {
                ...
                // the more I think about it, this is because fretboard was taken from bitar...
                // whereas omgbananas doesn't really deal with multitouch... i think
                if (touches.size() == 0) {
                    Note restNote = new Note();
                    restNote.setRest(true);
                    mChannel.playLiveNote(restNote, true);
